...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    let lst = !evt in
    let rec itr (lst : 'a waiter list) (lst2 : 'a waiter list)(id : id): 'a waiter list =
      match lst with
      | [] -> []
      | h :: t ->
        if h.id == id then t
        else itr t (h :: lst2) id in
    evt := itr lst [] i
...
......................................................................*)
    ...
    let fire_event (evt : 'a event) (arg : 'a) : unit =
      let lst = !evt in
      List.map (fun x -> x.action arg) lst;
      ()
...
......................................................................*)
let _ = remove_listener newswire id1 ;;
let _ = remove_listener newswire id2 ;;
(* .. *)
